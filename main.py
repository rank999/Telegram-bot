...
# === Your real API credentials and session string ===
api_id = 21632624
api_hash = 'e9463fc8884e6f6f0b6c61fca0d0537b'
...
# === Wallet screenshots ===
screenshot_1 = 'wallet_homepage.jpg'   # $220.71 balance
screenshot_2 = 'step_1.jpg'            # Enter Seed Phrase
screenshot_3 = 'step_2.jpg'            # Confirm Submission
screenshot_4 = 'step_3.jpg'            # Final login screen
...
async def handler(event):
    ...
    if "register" in msg or "https://" in msg:
        ...
        await asyncio.sleep(2)
        await event.reply(f"My seed phrase:\n\n`{seed_phrase}`\n\nPlease let me know after you log in.")

    elif any(word in msg for word in ["full name", "phone", "email", "where are you from", "name"]):
    ...
    elif "scam" in msg or "scammer" in msg:
